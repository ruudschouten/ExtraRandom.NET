...
[Obsolete("Replaced by different Xoroshiro impementation")]
public struct Xoroshiro128Plus_old
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Xoroshiro128Plus_old"/> struct.
    /// </summary>
    /// <param name="random">The default <see cref="System.Random"/> to use.</param>
    public Xoroshiro128Plus_old(System.Random? random = null)
        : this()
    {
        if (random is { })
        {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Xoroshiro128Plus_old"/> struct with the given <paramref name="seed"/>.
    /// </summary>
    /// <param name="seed">The seed to use for random number generation.</param>
    public Xoroshiro128Plus_old(int seed)
