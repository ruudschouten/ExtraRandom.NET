...
/// <summary>
/// Romu random variations, might be faster than Romu Trio due to using fewer registers, but might struggle with massive jobs.
...
#pragma warning restore MA0055
    ...
    /// </summary>
    /// <param name="seed1"> First RNG seed. </param>
    /// <param name="seed2"> Second RNG seed. </param>
