...
/// For generating just floating-point numbers, <see cref="Xoshiro256Plus">Xoroshiro256+</see> is even faster.
/// </para>
/// <para>
...
/// </summary>
/// <remarks>
/// <para>Source: https://prng.di.unimi.it/xoshiro256starstar.c</para>
/// </remarks>
public sealed class Xoshiro256StarStar : Random64
{
    /// <summary>
    ...
    public Xoshiro256StarStar(ulong baseSeed = 0)
    ...
    public Xoshiro256StarStar(ulong seed1, ulong seed2, ulong seed3, ulong seed4)
    {
        State = new ulong[4];
    ...
    protected override ulong Next()
    {
        ...
        return BitOperations.RotateLeft(State[1] * 5, 7) * 9;
    }
}
