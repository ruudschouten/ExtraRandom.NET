...
public static class CollectionExtension
{
    ...
    /// <example>
    /// <para>In this example; <c>list</c> has 10 elements.</para>
    /// <code>
    ...
    /// <summary>
    /// <para>Remove an item from the <paramref name="list"/> by swapping it with the last item. and then removing the last item.</para>
    /// <para>This should be an <c>O(1)</c> operation.</para>
    /// </summary>
    /// <param name="list">List of elements to remove an item from.</param>
    ...
    /// <remarks><para>This will only work correctly on a sorted list.</para></remarks>
    /// <returns><para>Index of the <paramref name="item"/>.</para>
    /// <para>
